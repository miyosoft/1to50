...
public class EncryptUtil {
    ...
    private String messageDigest(String res,String algorithm){
        try {
            ...
            return base64(md.digest(resBytes),Base64.DEFAULT);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    private String keyGeneratorMac(String res,String algorithm,String key){
        try {
            ...
            return base64(result,Base64.DEFAULT);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    private String base64(byte[] res,int flags){
        return new String(Base64.encode(res,flags));
    }
    ...
    public String AESencode(String res, String key) {
        try {
            ...
            byte[] byteContent = res.getBytes(CHARSET);
            //初始化为加密密码器
    ...
    public String AESdecode(String res, String key) {
        ...
        try {
            ...
            //执行解密操作
            byte[] result = cipher.doFinal(Base64.decode(res,Base64.DEFAULT));
